...
function Fish() {
  const modelsData = [
    { "hue": 0, "saturation": 209, "lightness": 50, "texture": 3, "position": [2, 1, -3] },
    /* { "hue": 149, "saturation": 189, "lightness": 40, "texture": 0, "position": [-5, -1.4, 2] },
    { "hue": 120, "saturation": 196, "lightness": 86, "texture": 1, "position": [-0.3, 0, 4] }, */
  ]
  ...
  useEffect(() => {
    models.position = modelsData.position;
  })
